-- ============================================================
-- Fix admin login: ensure ias2371@gmail.com can authenticate
-- with password Sp23Wk71@1994
-- ============================================================
...
BEGIN
  ...
  ELSE
    -- Force-update the password, confirm email, and clear any blocks
    UPDATE auth.users
    SET
