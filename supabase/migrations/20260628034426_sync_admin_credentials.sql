...
BEGIN
  ...
  -- Ensure profiles record exists with master role, active status, and MFA enabled
  INSERT INTO public.profiles (id, email, name, role, status, mfa_enabled, mfa_verified, mfa_type, tipo_usuario, is_client)
  VALUES (
    v_user_id,
    'ias2371@gmail.com',
    'Master Admin',
