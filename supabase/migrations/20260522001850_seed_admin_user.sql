...
DECLARE
  new_user_id uuid;
BEGIN
  -- Seed primary administrative user (idempotent: skip if email already exists)
  IF NOT EXISTS (SELECT 1 FROM auth.users WHERE email = 'ias2371@gmail.com') THEN
    ...
    -- Insert into dependent profiles table, handling potential auto-creation triggers
    INSERT INTO public.profiles (id, email, name, role, status)
    VALUES (new_user_id, 'ias2371@gmail.com', 'Admin', 'master', 'active')
